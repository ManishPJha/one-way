...
export class Employee {
    ...
    @prop({ type: String, required: [true, 'Please select qualifications.'], enum: Constants.Qualifications })
...
class Residents {
    ...
    @prop({ type: Number, required: true, maxlength: [6, 'maximum length for pincode is 6.'] })
